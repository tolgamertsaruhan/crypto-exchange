...
<body>
    ...
    <div class="card">
        <header class="header" style="text-align: center; margin-top: 15px;">Sign Up Page
        </header>
        <div class="card-body" style="width: 95%; margin: auto;">
            <form method="post" action="signupops.php" enctype="multipart/form-data">
                ...
                <a href="index.php" class="link-secondary">Log In</a>
            </form>
        </div>
    </div>
</body>
